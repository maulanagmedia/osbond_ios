...
class AppDelegate: UIResponder, UIApplicationDelegate , GIDSignInDelegate/*, MessagingDelegate, UNUserNotificationCenterDelegate*/{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        MidtransConfig.shared().setClientKey(MidtransRes.MERCHANT_CLIENT_KEY, environment: .production,
                                             merchantServerURL: MidtransRes.MERCHANT_BASE_CHECKOUT_URL)
...
extension AppDelegate : UNUserNotificationCenterDelegate {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        // Print full message.
        print("ISI PESAN \(userInfo)")
        
        DispatchQueue.main.async {
            
            HomeViewController.stateController = 2
